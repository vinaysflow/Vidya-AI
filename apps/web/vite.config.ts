...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Vid (Vidya) - Socratic AI Tutor',
        short_name: 'Vid (Vidya)',
        description: 'Learn by discovery with AI-powered Socratic tutoring',
        theme_color: '#3b82f6',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: /^https:\/\/api\.vidya\.app\/.*$/,
  ...
  preview: {
    allowedHosts: [
      ...
      'vidya-socratical-app-production.up.railway.app',
      '.up.railway.app',
    ]
  },
  define: {
