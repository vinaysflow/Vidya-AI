...
const CONCEPTS: ConceptSeed[] = [
  ...
  // Mechanics
  { conceptKey: 'phys_units_dimensions', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Measurement', name: 'Units & Dimensions', description: 'SI units, dimensional analysis, significant figures, error propagation. Foundation for all quantitative physics.', difficulty: 1, jeeRelevance: 4, neetRelevance: 3, prerequisites: [] },
  { conceptKey: 'phys_kinematics', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Kinematics', name: 'Kinematics', description: 'Motion in one and two dimensions: displacement, velocity, acceleration, equations of motion, projectile motion, relative motion.', difficulty: 2, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['phys_units_dimensions'] },
  { conceptKey: 'phys_newtons_laws', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Dynamics', name: "Newton's Laws of Motion", description: 'Three laws governing force and motion: inertia, F=ma, action-reaction. Free body diagrams, pseudo forces, constraint equations.', difficulty: 2, jeeRelevance: 10, neetRelevance: 8, prerequisites: ['phys_kinematics'] },
  { conceptKey: 'phys_friction', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Friction', name: 'Friction', description: 'Static and kinetic friction, coefficient of friction, inclined planes, circular motion with friction, banking of roads.', difficulty: 2, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['phys_newtons_laws'] },
  { conceptKey: 'phys_circular_motion', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Circular Motion', name: 'Circular Motion', description: 'Uniform and non-uniform circular motion, centripetal acceleration, vertical circles, conical pendulum.', difficulty: 3, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['phys_newtons_laws'] },
  { conceptKey: 'phys_work_energy', subject: 'PHYSICS', topic: 'Energy', subtopic: 'Work-Energy', name: 'Work and Energy', description: 'Work done by constant and variable forces, kinetic energy, potential energy, work-energy theorem, power.', difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['phys_newtons_laws'] },
  { conceptKey: 'phys_conservation_energy', subject: 'PHYSICS', topic: 'Energy', subtopic: 'Conservation', name: 'Conservation of Energy', description: 'Conservative and non-conservative forces, potential energy curves, mechanical energy conservation, energy in springs.', difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['phys_work_energy'] },
  { conceptKey: 'phys_com', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Center of Mass', name: 'Center of Mass', description: 'Center of mass of discrete and continuous systems, motion of COM, COM frame of reference.', difficulty: 3, jeeRelevance: 8, neetRelevance: 4, prerequisites: ['phys_newtons_laws'] },
  { conceptKey: 'phys_momentum', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Momentum', name: 'Momentum and Collisions', description: 'Linear momentum, impulse, conservation of momentum, elastic and inelastic collisions in 1D and 2D, rocket propulsion.', difficulty: 3, jeeRelevance: 9, neetRelevance: 6, prerequisites: ['phys_com', 'phys_conservation_energy'] },
  { conceptKey: 'phys_rotational', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Rotation', name: 'Rotational Motion', description: 'Torque, angular momentum, moment of inertia, rolling motion, parallel and perpendicular axis theorems.', difficulty: 4, jeeRelevance: 10, neetRelevance: 5, prerequisites: ['phys_momentum'] },
  { conceptKey: 'phys_gravitation', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Gravitation', name: 'Gravitation', description: "Newton's law of gravitation, gravitational field and potential, orbital mechanics, escape velocity, Kepler's laws, satellites.", difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['phys_circular_motion', 'phys_conservation_energy'] },
  { conceptKey: 'phys_fluid_mechanics', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Fluids', name: 'Fluid Mechanics', description: "Pressure, Pascal's law, Archimedes' principle, Bernoulli's equation, viscosity, surface tension, capillarity.", difficulty: 3, jeeRelevance: 7, neetRelevance: 5, prerequisites: ['phys_newtons_laws'] },
  { conceptKey: 'phys_elasticity', subject: 'PHYSICS', topic: 'Mechanics', subtopic: 'Elasticity', name: 'Elasticity', description: "Stress, strain, Young's modulus, bulk modulus, shear modulus, Hooke's law, elastic energy.", difficulty: 2, jeeRelevance: 5, neetRelevance: 4, prerequisites: ['phys_work_energy'] },

  // Waves & Oscillations
  { conceptKey: 'phys_shm', subject: 'PHYSICS', topic: 'Waves', subtopic: 'Oscillations', name: 'Simple Harmonic Motion', description: 'Springs, pendulums, restoring force, frequency, amplitude, phase, energy in SHM, superposition of SHMs.', difficulty: 3, jeeRelevance: 9, neetRelevance: 6, prerequisites: ['phys_work_energy'] },
  { conceptKey: 'phys_waves', subject: 'PHYSICS', topic: 'Waves', subtopic: 'Wave Motion', name: 'Waves', description: 'Transverse and longitudinal waves, wave equation, superposition, interference, standing waves, harmonics.', difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['phys_shm'] },
  { conceptKey: 'phys_sound', subject: 'PHYSICS', topic: 'Waves', subtopic: 'Sound', name: 'Sound Waves', description: 'Speed of sound in media, Doppler effect, resonance, beats, organ pipes, vibrating strings.', difficulty: 3, jeeRelevance: 7, neetRelevance: 5, prerequisites: ['phys_waves'] },

  // Optics
  { conceptKey: 'phys_optics', subject: 'PHYSICS', topic: 'Optics', subtopic: 'Geometric', name: 'Geometric Optics', description: 'Reflection, refraction, mirrors, lenses, ray diagrams, lens maker formula, prisms, total internal reflection.', difficulty: 3, jeeRelevance: 8, neetRelevance: 7, prerequisites: ['phys_waves'] },
  { conceptKey: 'phys_wave_optics', subject: 'PHYSICS', topic: 'Optics', subtopic: 'Wave Optics', name: 'Wave Optics', description: "Interference, Young's double slit, thin films, diffraction, Fraunhofer single slit, polarization, resolving power.", difficulty: 4, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['phys_optics'] },
  { conceptKey: 'phys_optical_instruments', subject: 'PHYSICS', topic: 'Optics', subtopic: 'Instruments', name: 'Optical Instruments', description: 'Human eye, microscopes, telescopes, magnifying power, aberrations.', difficulty: 2, jeeRelevance: 4, neetRelevance: 6, prerequisites: ['phys_optics'] },

  // Thermodynamics
  { conceptKey: 'phys_thermo_1', subject: 'PHYSICS', topic: 'Thermodynamics', subtopic: 'Heat Transfer', name: 'Thermal Physics', description: 'Temperature scales, thermal expansion, calorimetry, specific heat, latent heat, heat transfer: conduction, convection, radiation.', difficulty: 2, jeeRelevance: 7, neetRelevance: 6, prerequisites: ['phys_work_energy'] },
  { conceptKey: 'phys_kinetic_theory', subject: 'PHYSICS', topic: 'Thermodynamics', subtopic: 'Kinetic Theory', name: 'Kinetic Theory of Gases', description: 'Ideal gas law, kinetic interpretation of temperature, degrees of freedom, specific heats of gases, mean free path.', difficulty: 3, jeeRelevance: 7, neetRelevance: 5, prerequisites: ['phys_thermo_1'] },
  { conceptKey: 'phys_thermo_2', subject: 'PHYSICS', topic: 'Thermodynamics', subtopic: 'Laws', name: 'Thermodynamics Laws', description: 'Zeroth, first, and second laws, entropy, isothermal/adiabatic/isochoric processes, Carnot cycle, heat engines, refrigerators.', difficulty: 4, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['phys_kinetic_theory'] },

  // Electricity & Magnetism
  { conceptKey: 'phys_electrostatics', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'Electrostatics', name: 'Electrostatics', description: "Coulomb's law, electric field and field lines, electric potential, equipotential surfaces, Gauss's law, electric dipole.", difficulty: 3, jeeRelevance: 10, neetRelevance: 6, prerequisites: [] },
  { conceptKey: 'phys_capacitors', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'Capacitors', name: 'Capacitors & Dielectrics', description: 'Parallel plate capacitor, series/parallel combinations, energy stored, effect of dielectrics, Van de Graaff generator.', difficulty: 3, jeeRelevance: 8, neetRelevance: 4, prerequisites: ['phys_electrostatics'] },
  { conceptKey: 'phys_current_elec', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'Current', name: 'Current Electricity', description: "Ohm's law, drift velocity, resistance, resistivity, Kirchhoff's laws, Wheatstone bridge, potentiometer, meter bridge.", difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['phys_electrostatics'] },
  { conceptKey: 'phys_magnetism', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'Magnetism', name: 'Moving Charges & Magnetism', description: "Biot-Savart law, Ampere's law, Lorentz force, motion in magnetic field, cyclotron, solenoid, toroid.", difficulty: 4, jeeRelevance: 9, neetRelevance: 5, prerequisites: ['phys_current_elec'] },
  { conceptKey: 'phys_magnetism_matter', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'Magnetism in Matter', name: 'Magnetism & Matter', description: 'Earth magnetism, magnetic properties of materials, dia/para/ferromagnetism, hysteresis, bar magnet as dipole.', difficulty: 3, jeeRelevance: 5, neetRelevance: 4, prerequisites: ['phys_magnetism'] },
  { conceptKey: 'phys_em_induction', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'EM Induction', name: 'Electromagnetic Induction', description: "Faraday's law, Lenz's law, motional EMF, eddy currents, self and mutual inductance, AC generator.", difficulty: 4, jeeRelevance: 9, neetRelevance: 5, prerequisites: ['phys_magnetism'] },
  { conceptKey: 'phys_ac', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'AC', name: 'Alternating Current', description: 'AC voltage, phasor diagrams, RLC circuits, resonance, power factor, transformers, LC oscillations.', difficulty: 4, jeeRelevance: 8, neetRelevance: 4, prerequisites: ['phys_em_induction', 'phys_capacitors'] },
  { conceptKey: 'phys_em_waves', subject: 'PHYSICS', topic: 'Electricity', subtopic: 'EM Waves', name: 'Electromagnetic Waves', description: "Maxwell's equations (qualitative), EM wave spectrum, properties, uses of different bands.", difficulty: 2, jeeRelevance: 5, neetRelevance: 4, prerequisites: ['phys_em_induction'] },

  // Modern Physics
  { conceptKey: 'phys_dual_nature', subject: 'PHYSICS', topic: 'Modern Physics', subtopic: 'Dual Nature', name: 'Dual Nature of Radiation', description: 'Photoelectric effect, Einstein equation, de Broglie wavelength, Davisson-Germer experiment, photon energy.', difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['phys_wave_optics'] },
  { conceptKey: 'phys_atoms', subject: 'PHYSICS', topic: 'Modern Physics', subtopic: 'Atoms', name: 'Atoms & Spectra', description: "Bohr model, hydrogen spectrum, energy levels, X-rays, Moseley's law.", difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['phys_dual_nature', 'phys_electrostatics'] },
  { conceptKey: 'phys_nuclei', subject: 'PHYSICS', topic: 'Modern Physics', subtopic: 'Nuclear', name: 'Nuclei & Radioactivity', description: 'Nuclear binding energy, mass defect, radioactive decay (alpha, beta, gamma), half-life, fission, fusion.', difficulty: 3, jeeRelevance: 7, neetRelevance: 6, prerequisites: ['phys_atoms'] },
  { conceptKey: 'phys_semiconductors', subject: 'PHYSICS', topic: 'Modern Physics', subtopic: 'Semiconductors', name: 'Semiconductor Electronics', description: 'p-n junction, diode, LED, photodiode, solar cell, transistor, logic gates, Boolean algebra.', difficulty: 3, jeeRelevance: 6, neetRelevance: 5, prerequisites: ['phys_current_elec'] },
  ...
  // Physical Chemistry
  { conceptKey: 'chem_atomic', subject: 'CHEMISTRY', topic: 'Structure', name: 'Atomic Structure', description: 'Bohr model, quantum numbers, electron configuration, aufbau principle, periodic trends, photoelectric effect.', difficulty: 2, jeeRelevance: 8, neetRelevance: 7, prerequisites: [] },
  { conceptKey: 'chem_periodic_table', subject: 'CHEMISTRY', topic: 'Structure', name: 'Periodic Table & Properties', description: 'Periodicity in atomic radius, ionization energy, electron affinity, electronegativity, metallic character.', difficulty: 2, jeeRelevance: 7, neetRelevance: 7, prerequisites: ['chem_atomic'] },
  { conceptKey: 'chem_bonding', subject: 'CHEMISTRY', topic: 'Structure', name: 'Chemical Bonding', description: 'Ionic, covalent, metallic bonds, VSEPR theory, hybridization (sp, sp2, sp3, sp3d, sp3d2), molecular orbital theory, bond order.', difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['chem_atomic'] },
  { conceptKey: 'chem_states', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'States of Matter', description: 'Ideal gas law, real gases, van der Waals equation, liquefaction, intermolecular forces, liquid state properties.', difficulty: 2, jeeRelevance: 6, neetRelevance: 5, prerequisites: ['chem_bonding'] },
  { conceptKey: 'chem_thermo', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Chemical Thermodynamics', description: 'Internal energy, enthalpy, Hess law, bond enthalpy, entropy, Gibbs free energy, spontaneity criteria.', difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['chem_states'] },
  { conceptKey: 'chem_equilibrium', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Chemical Equilibrium', description: "Le Chatelier's principle, equilibrium constants (Kp, Kc, Ksp), ionic equilibrium, pH, buffer solutions, Henderson-Hasselbalch.", difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['chem_thermo'] },
  { conceptKey: 'chem_kinetics', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Chemical Kinetics', description: 'Rate laws, order and molecularity, integrated rate equations, half-life, Arrhenius equation, collision theory, catalysis.', difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['chem_equilibrium'] },
  { conceptKey: 'chem_solutions', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Solutions', description: "Colligative properties (boiling point elevation, freezing point depression, osmotic pressure), Raoult's law, Henry's law, Van't Hoff factor.", difficulty: 3, jeeRelevance: 7, neetRelevance: 6, prerequisites: ['chem_states'] },
  { conceptKey: 'chem_redox', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Electrochemistry', description: 'Oxidation numbers, balancing redox, galvanic cells, electrode potential, Nernst equation, electrolysis, Faraday laws, batteries, corrosion.', difficulty: 3, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['chem_kinetics'] },
  { conceptKey: 'chem_solid_state', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Solid State', description: 'Crystal lattices, unit cells (cubic systems), packing efficiency, defects, electrical and magnetic properties.', difficulty: 3, jeeRelevance: 6, neetRelevance: 4, prerequisites: ['chem_bonding'] },
  { conceptKey: 'chem_surface', subject: 'CHEMISTRY', topic: 'Physical Chemistry', name: 'Surface Chemistry', description: 'Adsorption (physisorption vs chemisorption), catalysis, colloids (types, properties, Tyndall effect), emulsions.', difficulty: 3, jeeRelevance: 5, neetRelevance: 4, prerequisites: ['chem_solutions'] },

  // Inorganic Chemistry
  { conceptKey: 'chem_hydrogen', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'Hydrogen & s-Block', description: 'Hydrogen isotopes, water properties, alkali and alkaline earth metals, diagonal relationship, biological importance.', difficulty: 2, jeeRelevance: 5, neetRelevance: 5, prerequisites: ['chem_periodic_table'] },
  { conceptKey: 'chem_p_block_1', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'p-Block Elements (Group 13-14)', description: 'Boron family, carbon family, allotropy, borax, silicones, silicates, important compounds.', difficulty: 2, jeeRelevance: 6, neetRelevance: 5, prerequisites: ['chem_periodic_table'] },
  { conceptKey: 'chem_p_block_2', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'p-Block Elements (Group 15-18)', description: 'Nitrogen, phosphorus, oxygen, sulphur families, halogens, noble gases, ozone, interhalogen compounds.', difficulty: 3, jeeRelevance: 7, neetRelevance: 6, prerequisites: ['chem_p_block_1'] },
  { conceptKey: 'chem_d_block', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'd-Block & f-Block Elements', description: 'Transition metals, variable oxidation states, color, magnetic properties, catalytic activity, lanthanoids, actinoids.', difficulty: 3, jeeRelevance: 7, neetRelevance: 5, prerequisites: ['chem_periodic_table'] },
  { conceptKey: 'chem_coordination', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'Coordination Compounds', description: 'Werner theory, IUPAC naming, isomerism (geometric, optical), crystal field theory, spectrochemical series, stability.', difficulty: 4, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['chem_d_block', 'chem_bonding'] },
  { conceptKey: 'chem_qualitative', subject: 'CHEMISTRY', topic: 'Inorganic', name: 'Qualitative Analysis', description: 'Systematic analysis of cations and anions, flame tests, group reagents, confirmatory tests.', difficulty: 2, jeeRelevance: 6, neetRelevance: 3, prerequisites: ['chem_equilibrium'] },

  // Organic Chemistry
  { conceptKey: 'chem_organic_basics', subject: 'CHEMISTRY', topic: 'Organic', name: 'Organic Chemistry Basics', description: 'Nomenclature (IUPAC), structural and stereoisomerism, electronic effects (inductive, mesomeric, hyperconjugation), reaction intermediates.', difficulty: 3, jeeRelevance: 9, neetRelevance: 7, prerequisites: ['chem_bonding'] },
  { conceptKey: 'chem_hydrocarbons', subject: 'CHEMISTRY', topic: 'Organic', name: 'Hydrocarbons', description: 'Alkanes (combustion, halogenation), alkenes (addition), alkynes, aromatic compounds (electrophilic substitution), Huckel rule.', difficulty: 3, jeeRelevance: 8, neetRelevance: 6, prerequisites: ['chem_organic_basics'] },
  { conceptKey: 'chem_haloalkanes', subject: 'CHEMISTRY', topic: 'Organic', name: 'Haloalkanes & Haloarenes', description: 'SN1, SN2 mechanisms, E1, E2 elimination, nucleophilic substitution, Grignard reagents, Wurtz reaction.', difficulty: 3, jeeRelevance: 8, neetRelevance: 5, prerequisites: ['chem_hydrocarbons'] },
  { conceptKey: 'chem_alcohols', subject: 'CHEMISTRY', topic: 'Organic', name: 'Alcohols, Phenols, Ethers', description: 'Preparation, properties, acidity comparison, reactions, Williamson synthesis, electrophilic substitution in phenols.', difficulty: 3, jeeRelevance: 7, neetRelevance: 6, prerequisites: ['chem_haloalkanes'] },
  { conceptKey: 'chem_carbonyls', subject: 'CHEMISTRY', topic: 'Organic', name: 'Aldehydes, Ketones, Carboxylic Acids', description: 'Nucleophilic addition, aldol condensation, Cannizzaro, acidity of carboxylic acids, ester formation, anhydrides.', difficulty: 4, jeeRelevance: 9, neetRelevance: 6, prerequisites: ['chem_alcohols'] },
  { conceptKey: 'chem_amines', subject: 'CHEMISTRY', topic: 'Organic', name: 'Amines & Diazonium', description: 'Classification, basicity, preparation, Gabriel synthesis, Hofmann elimination, diazonium salts, coupling reactions.', difficulty: 3, jeeRelevance: 7, neetRelevance: 5, prerequisites: ['chem_carbonyls'] },
  { conceptKey: 'chem_polymers', subject: 'CHEMISTRY', topic: 'Applied', name: 'Polymers', description: 'Addition vs condensation, natural and synthetic polymers (nylon, Bakelite, rubber), biodegradable polymers.', difficulty: 2, jeeRelevance: 4, neetRelevance: 5, prerequisites: ['chem_organic_basics'] },
  { conceptKey: 'chem_biomolecules', subject: 'CHEMISTRY', topic: 'Applied', name: 'Biomolecules', description: 'Carbohydrates (mono/di/polysaccharides), amino acids, proteins, enzymes, vitamins, nucleic acids, DNA/RNA.', difficulty: 2, jeeRelevance: 4, neetRelevance: 8, prerequisites: ['chem_organic_basics'] },
  { conceptKey: 'chem_env', subject: 'CHEMISTRY', topic: 'Applied', name: 'Environmental Chemistry', description: 'Air/water/soil pollution, greenhouse effect, ozone depletion, acid rain, green chemistry principles, waste management.', difficulty: 1, jeeRelevance: 2, neetRelevance: 4, prerequisites: [] },
  { conceptKey: 'chem_everyday', subject: 'CHEMISTRY', topic: 'Applied', name: 'Chemistry in Everyday Life', description: 'Drugs (analgesics, antibiotics, antiseptics), soaps, detergents, food preservatives, artificial sweeteners.', difficulty: 1, jeeRelevance: 3, neetRelevance: 6, prerequisites: ['chem_organic_basics'] },
  ...
  // Algebra
  { conceptKey: 'math_sets', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Sets, Relations & Functions', description: 'Set operations, Venn diagrams, types of relations (reflexive, symmetric, transitive, equivalence), types of functions (injective, surjective, bijective).', difficulty: 1, jeeRelevance: 5, prerequisites: [] },
  { conceptKey: 'math_complex', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Complex Numbers', description: 'Argand plane, modulus, argument, polar and exponential form, De Moivre theorem, nth roots of unity, geometric applications.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_sets'] },
  { conceptKey: 'math_quadratic', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Quadratic Equations & Inequalities', description: 'Discriminant, nature of roots, Vieta formulas, quadratic inequalities, modulus equations, location of roots.', difficulty: 2, jeeRelevance: 9, prerequisites: ['math_sets'] },
  { conceptKey: 'math_sequences', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Sequences & Series', description: 'AP, GP, HP, AGP, summation techniques (telescoping, V_n method), AM-GM-HM inequality, convergence.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_quadratic'] },
  { conceptKey: 'math_binomial', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Binomial Theorem', description: 'Binomial expansion, general term, middle term, properties of binomial coefficients, multinomial theorem.', difficulty: 3, jeeRelevance: 7, prerequisites: ['math_permutations'] },
  { conceptKey: 'math_permutations', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Permutations & Combinations', description: 'Fundamental counting principle, nPr, nCr, arrangements with restrictions, circular permutations, derangements, distribution problems.', difficulty: 3, jeeRelevance: 9, prerequisites: ['math_sets'] },
  { conceptKey: 'math_matrices', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Matrices & Determinants', description: 'Matrix operations, types, inverse, adjoint, determinant properties, Cramer rule, system of linear equations, rank.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_sets'] },
  { conceptKey: 'math_mathematical_induction', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Mathematical Induction', description: 'Principle of induction, strong induction, proving divisibility, inequality, and summation identities.', difficulty: 2, jeeRelevance: 4, prerequisites: ['math_sequences'] },
  { conceptKey: 'math_logarithms', subject: 'MATHEMATICS', topic: 'Algebra', name: 'Logarithms & Exponentials', description: 'Laws of logarithms, change of base, logarithmic equations and inequalities, exponential growth/decay.', difficulty: 2, jeeRelevance: 6, prerequisites: ['math_sets'] },

  // Trigonometry
  { conceptKey: 'math_trig', subject: 'MATHEMATICS', topic: 'Trigonometry', name: 'Trigonometric Functions', description: 'Ratios, identities (sum/difference, double/half angle), trigonometric equations, domain, range, graphs.', difficulty: 2, jeeRelevance: 8, prerequisites: ['math_sets'] },
  { conceptKey: 'math_inverse_trig', subject: 'MATHEMATICS', topic: 'Trigonometry', name: 'Inverse Trigonometric Functions', description: 'Principal values, properties, composition formulas, equations involving inverse trig functions.', difficulty: 3, jeeRelevance: 7, prerequisites: ['math_trig'] },
  { conceptKey: 'math_trig_equations', subject: 'MATHEMATICS', topic: 'Trigonometry', name: 'Solution of Triangles', description: 'Sine rule, cosine rule, projection formula, area formulas, circumradius, inradius, heights and distances.', difficulty: 3, jeeRelevance: 6, prerequisites: ['math_trig'] },

  // Calculus
  { conceptKey: 'math_limits', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Limits & Continuity', description: "Limit evaluation (algebraic, trigonometric, exponential), L'Hopital rule, sandwich theorem, continuity, IVT.", difficulty: 3, jeeRelevance: 8, prerequisites: ['math_trig'] },
  { conceptKey: 'math_derivatives', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Differentiation', description: 'First principles, chain rule, product/quotient rule, implicit and parametric differentiation, logarithmic differentiation.', difficulty: 3, jeeRelevance: 9, prerequisites: ['math_limits'] },
  { conceptKey: 'math_applications_derivatives', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Applications of Derivatives', description: 'Tangent/normal, rate of change, monotonicity, maxima/minima, Rolle and Lagrange MVT, curve sketching.', difficulty: 3, jeeRelevance: 9, prerequisites: ['math_derivatives'] },
  { conceptKey: 'math_integrals', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Indefinite Integration', description: 'Standard integrals, substitution, partial fractions, integration by parts, reduction formulas, special techniques.', difficulty: 3, jeeRelevance: 10, prerequisites: ['math_derivatives'] },
  { conceptKey: 'math_definite_integrals', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Definite Integrals & Area', description: 'Properties of definite integrals, Leibniz rule, Walli formula, area under curves, area between curves.', difficulty: 4, jeeRelevance: 9, prerequisites: ['math_integrals'] },
  { conceptKey: 'math_diffeq', subject: 'MATHEMATICS', topic: 'Calculus', name: 'Differential Equations', description: 'Formation, order and degree, variable separable, homogeneous, linear first order, exact equations, applications.', difficulty: 4, jeeRelevance: 8, prerequisites: ['math_integrals'] },

  // Coordinate Geometry
  { conceptKey: 'math_straight_lines', subject: 'MATHEMATICS', topic: 'Geometry', name: 'Straight Lines', description: 'Slope, intercept forms, distance formulas, angle between lines, family of lines, concurrency, locus problems.', difficulty: 2, jeeRelevance: 7, prerequisites: ['math_sets'] },
  { conceptKey: 'math_circles', subject: 'MATHEMATICS', topic: 'Geometry', name: 'Circles', description: 'Standard and general equation, tangent, normal, chord of contact, family of circles, radical axis, coaxial circles.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_straight_lines'] },
  { conceptKey: 'math_conics', subject: 'MATHEMATICS', topic: 'Geometry', name: 'Conic Sections', description: 'Parabola, ellipse, hyperbola: standard forms, tangents, normals, focal chords, eccentricity, latus rectum.', difficulty: 4, jeeRelevance: 9, prerequisites: ['math_circles'] },
  { conceptKey: 'math_vectors', subject: 'MATHEMATICS', topic: 'Geometry', name: 'Vectors', description: 'Dot product, cross product, scalar triple product, section formula, area of triangle/parallelogram, coplanarity.', difficulty: 3, jeeRelevance: 7, prerequisites: ['math_matrices'] },
  { conceptKey: 'math_3d_geometry', subject: 'MATHEMATICS', topic: 'Geometry', name: '3D Geometry', description: 'Direction cosines/ratios, equations of line and plane, angle between planes, skew lines, shortest distance.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_vectors'] },

  // Statistics & Probability
  { conceptKey: 'math_statistics', subject: 'MATHEMATICS', topic: 'Statistics', name: 'Statistics', description: 'Mean, median, mode, variance, standard deviation, grouped/ungrouped data, ogives.', difficulty: 2, jeeRelevance: 3, prerequisites: ['math_sets'] },
  { conceptKey: 'math_probability', subject: 'MATHEMATICS', topic: 'Statistics', name: 'Probability', description: 'Conditional probability, Bayes theorem, independent events, random variables, binomial distribution, expectation.', difficulty: 3, jeeRelevance: 8, prerequisites: ['math_permutations'] },
  ...
  { conceptKey: 'bio_cell', subject: 'BIOLOGY', topic: 'Cell Biology', name: 'Cell Structure', description: 'Prokaryotic vs eukaryotic cells, cell organelles (nucleus, mitochondria, ER, Golgi, lysosomes, ribosomes), cell membrane structure.', difficulty: 2, neetRelevance: 9, prerequisites: [] },
  { conceptKey: 'bio_cell_division', subject: 'BIOLOGY', topic: 'Cell Biology', name: 'Cell Division', description: 'Cell cycle phases, mitosis (stages, significance), meiosis (stages, crossing over, significance), comparison.', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_cell'] },
  { conceptKey: 'bio_biomolecules', subject: 'BIOLOGY', topic: 'Biochemistry', name: 'Biomolecules', description: 'Carbohydrates, proteins (primary to quaternary structure), lipids, nucleic acids, vitamins, enzymes (lock-and-key, induced fit).', difficulty: 2, neetRelevance: 8, prerequisites: ['bio_cell'] },
  { conceptKey: 'bio_cell_transport', subject: 'BIOLOGY', topic: 'Cell Biology', name: 'Transport in Cells', description: 'Passive transport (diffusion, osmosis, facilitated), active transport, endocytosis, exocytosis, membrane potential.', difficulty: 2, neetRelevance: 7, prerequisites: ['bio_cell'] },

  // Genetics & Evolution
  { conceptKey: 'bio_mendelian', subject: 'BIOLOGY', topic: 'Genetics', name: 'Mendelian Genetics', description: "Mendel's laws, monohybrid and dihybrid crosses, incomplete dominance, codominance, multiple alleles, pleiotropy.", difficulty: 3, neetRelevance: 10, prerequisites: ['bio_cell_division'] },
  { conceptKey: 'bio_chromosomal', subject: 'BIOLOGY', topic: 'Genetics', name: 'Chromosomal Inheritance', description: 'Sex determination (XX-XY, ZW-ZZ), sex-linked inheritance, linkage, crossing over, chromosomal disorders (Down, Turner, Klinefelter).', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_mendelian'] },
  { conceptKey: 'bio_molecular', subject: 'BIOLOGY', topic: 'Genetics', name: 'Molecular Biology', description: 'DNA structure (Watson-Crick), replication (semi-conservative), transcription, genetic code, translation, gene regulation (lac operon).', difficulty: 4, neetRelevance: 10, prerequisites: ['bio_chromosomal'] },
  { conceptKey: 'bio_biotech_principles', subject: 'BIOLOGY', topic: 'Biotechnology', name: 'Biotechnology Principles', description: 'Restriction enzymes, cloning vectors, PCR, gel electrophoresis, recombinant DNA technology, DNA fingerprinting.', difficulty: 4, neetRelevance: 8, prerequisites: ['bio_molecular'] },
  { conceptKey: 'bio_biotech_applications', subject: 'BIOLOGY', topic: 'Biotechnology', name: 'Biotechnology Applications', description: 'Transgenic organisms, gene therapy, GMOs, Bt crops, golden rice, insulin production, ethical issues.', difficulty: 3, neetRelevance: 7, prerequisites: ['bio_biotech_principles'] },
  { conceptKey: 'bio_evolution', subject: 'BIOLOGY', topic: 'Evolution', name: 'Evolution', description: 'Origin of life, Darwinism, modern synthetic theory, Hardy-Weinberg equilibrium, natural selection types, speciation, human evolution.', difficulty: 3, neetRelevance: 7, prerequisites: ['bio_mendelian'] },

  // Human Physiology
  { conceptKey: 'bio_digestion', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Digestion & Absorption', description: 'Alimentary canal, digestive glands, enzymes, digestion in mouth/stomach/intestine, absorption, disorders.', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_biomolecules'] },
  { conceptKey: 'bio_breathing', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Breathing & Gas Exchange', description: 'Respiratory organs, mechanism of breathing, gas exchange, oxygen and CO2 transport, respiratory volumes, disorders.', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_cell'] },
  { conceptKey: 'bio_circulation', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Body Fluids & Circulation', description: 'Blood composition, blood groups (ABO, Rh), coagulation, heart anatomy, cardiac cycle, ECG, blood pressure, disorders.', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_cell'] },
  { conceptKey: 'bio_excretion', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Excretory System', description: 'Kidney structure, nephron, urine formation (filtration, reabsorption, secretion), regulation, dialysis, disorders.', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_circulation'] },
  { conceptKey: 'bio_locomotion', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Locomotion & Movement', description: 'Types of movement, skeletal system, joints, muscle structure, sliding filament theory, disorders (arthritis, osteoporosis).', difficulty: 2, neetRelevance: 7, prerequisites: ['bio_cell'] },
  { conceptKey: 'bio_neural', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Neural Control', description: 'Neuron structure, nerve impulse transmission, synapse, central and peripheral nervous system, reflex arc, brain anatomy.', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_cell_transport'] },
  { conceptKey: 'bio_hormones', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Chemical Coordination', description: 'Endocrine glands, hormones and their functions, feedback mechanisms, disorders (diabetes, dwarfism, goitre).', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_neural'] },
  { conceptKey: 'bio_immunity', subject: 'BIOLOGY', topic: 'Human Physiology', name: 'Immunity', description: 'Innate and adaptive immunity, humoral and cell-mediated, antibodies, vaccination, allergies, autoimmunity, AIDS.', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_circulation'] },

  // Plant Biology
  { conceptKey: 'bio_plant_morphology', subject: 'BIOLOGY', topic: 'Plant Biology', name: 'Plant Morphology & Anatomy', description: 'Root, stem, leaf modifications, flower parts, inflorescence types, tissue systems (meristematic, permanent).', difficulty: 2, neetRelevance: 7, prerequisites: [] },
  { conceptKey: 'bio_photosynthesis', subject: 'BIOLOGY', topic: 'Plant Biology', name: 'Photosynthesis', description: 'Light reactions, photosystems I & II, Calvin cycle, C3/C4/CAM pathways, photorespiration, factors affecting.', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_cell', 'bio_biomolecules'] },
  { conceptKey: 'bio_respiration', subject: 'BIOLOGY', topic: 'Plant Biology', name: 'Plant Respiration', description: 'Glycolysis, Krebs cycle, electron transport chain, oxidative phosphorylation, fermentation, respiratory quotient.', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_photosynthesis'] },
  { conceptKey: 'bio_plant_growth', subject: 'BIOLOGY', topic: 'Plant Biology', name: 'Plant Growth & Hormones', description: 'Growth phases, plant hormones (auxins, gibberellins, cytokinins, ethylene, ABA), photoperiodism, vernalization.', difficulty: 3, neetRelevance: 7, prerequisites: ['bio_plant_morphology'] },

  // Ecology & Reproduction
  { conceptKey: 'bio_ecology', subject: 'BIOLOGY', topic: 'Ecology', name: 'Ecology & Ecosystems', description: 'Organism interactions, population attributes, food chains/webs, ecological pyramids, nutrient cycling, ecological succession.', difficulty: 2, neetRelevance: 8, prerequisites: [] },
  { conceptKey: 'bio_biodiversity', subject: 'BIOLOGY', topic: 'Ecology', name: 'Biodiversity & Conservation', description: 'Patterns of biodiversity, loss of biodiversity, conservation strategies (in-situ, ex-situ), hotspots, Red Data Book.', difficulty: 2, neetRelevance: 6, prerequisites: ['bio_ecology'] },
  { conceptKey: 'bio_reproduction', subject: 'BIOLOGY', topic: 'Reproduction', name: 'Reproduction in Organisms', description: 'Asexual (fission, budding, fragmentation, spores), sexual reproduction in flowering plants (pollination, fertilization, embryo).', difficulty: 3, neetRelevance: 8, prerequisites: ['bio_cell_division'] },
  { conceptKey: 'bio_human_reproduction', subject: 'BIOLOGY', topic: 'Reproduction', name: 'Human Reproduction', description: 'Male and female reproductive systems, gametogenesis, menstrual cycle, fertilization, implantation, pregnancy, parturition.', difficulty: 3, neetRelevance: 9, prerequisites: ['bio_reproduction'] },
  { conceptKey: 'bio_reproductive_health', subject: 'BIOLOGY', topic: 'Reproduction', name: 'Reproductive Health', description: 'Population control, contraception methods, STDs, infertility treatments (IVF, ICSI), amniocentesis, MTP.', difficulty: 2, neetRelevance: 7, prerequisites: ['bio_human_reproduction'] },
  ...
  for (const c of CONCEPTS) {
    const result = await prisma.concept.upsert({
      ...
      update: {
        ...
        jeeRelevance: c.jeeRelevance ?? 0,
        neetRelevance: c.neetRelevance ?? 0,
